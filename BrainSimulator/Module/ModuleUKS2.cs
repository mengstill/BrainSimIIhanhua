    ...
    public class ModuleUKS2 : ModuleUKS
    {
        ...
        public override void DeleteThing(Thing t)
        {
            ...
            if (i > -1)
            {
                ...
                {
                    神经元 sourceNeuron = GetNeuron(j, false);
                    神经元 targetNeuron = PrevNeuron(sourceNeuron);
                    MainWindow.thisWindow.此神经元数组视图.MoveOneNeuron(sourceNeuron, targetNeuron);
        ...
        神经元 GetNeuron(int i, bool input = true)
        {
            int col = i / mv.Height;
            int row = i % mv.Height;
            col = col * 2;
