...
namespace BrainSimulator.Modules
{
    public class Module2DTouch : ModuleBase
    {
        ...
        {
            ClearNeurons();
            mv.GetNeuronAt(0, 0).标签名 = "Right";
            mv.GetNeuronAt(0, 1).标签名 = "Left";
            mv.GetNeuronAt(1, 0).标签名 = "R";
            mv.GetNeuronAt(2, 0).标签名 = "θ";
            mv.GetNeuronAt(3, 0).标签名 = "Collθ";
            mv.GetNeuronAt(4, 0).标签名 = "P1";
            mv.GetNeuronAt(5, 0).标签名 = "L1";
            mv.GetNeuronAt(6, 0).标签名 = "P2";
            mv.GetNeuronAt(7, 0).标签名 = "L2";
            mv.GetNeuronAt(8, 0).标签名 = "Done►";
            mv.GetNeuronAt(9, 0).标签名 = "mR";
