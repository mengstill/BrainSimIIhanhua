...
namespace BrainSimulator.Modules
{
    public class ModuleGoToDest : ModuleBase
    {
        ...
        public override void Fire()
        {
            ...
            ///else recursive?
            ///
            模块视图 naBehavior = MainWindow.此神经元数组.FindModuleByLabel("ModuleBehavior");
            if (naBehavior == null) return;
            ModuleBehavior nmBehavior = (ModuleBehavior)naBehavior.TheModule;
            模块视图 naModel = theNeuronArray.FindModuleByLabel("Module2DModel");
            ...
            if (pvTarget != null)
            {
                ...
                {
                    PointPlus pvTry1 = 跨语言接口.ExtendSegment(obstacle.P1.P, obstacle.P2.P, 0.5f, true);
                    PointPlus pvTry2 = 跨语言接口.ExtendSegment(obstacle.P1.P, obstacle.P2.P, 0.5f, false);
        ...
        public override void Initialize()
        {
            ...
            mv.GetNeuronAt(1, 0).Model = 神经元.模型类型.FloatValue;
